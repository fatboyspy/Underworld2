...
public class Gamer : Creature, IFight
{
    PlayerRace race;
    ...
    /// <param name="witness">Смекалка</param>
    /// <param name="mentalStrength">Мудрость</param>
    /// <param name="charisma">Харизма</param>    
    public Gamer(string name, PlayerRace race, CreatureGender gender, PlayerOccupation occupation, int level, int strength, int constitution, int dextirity, int intelligence, int witness, int mentalStrength, int charisma)
    {
        Name = name;
        Race = race;
        Gender = gender;
    ...
    public void CalculateStats()
    {
        ...
        CastingSpeed = (int)(Intelligence * 0.63 * Witness * 0.5);
        ...
        ExpirienceToLevelUp = (int)(Level / 85 * 1000 * LevelModifier);
    ...
    public void CalculateStats(int p_attack_mod, int m_attack_mod, int p_defence_mod, int m_defence_mod, int accuracy_mod, int p_attack_spd_mod, int casting_spd_mod, int critical_chance_mod, int evasion_mod, int hp_mod, int mp_mod)
    {
        ...
        CastingSpeed = (int)(Intelligence * 0.63 * Witness * 0.5) + casting_spd_mod;
